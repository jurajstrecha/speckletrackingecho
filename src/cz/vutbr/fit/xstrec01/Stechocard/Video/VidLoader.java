...
final public class VidLoader {
    ...
    public static boolean load(String path, VidData vidData) {
        ...
        if (!cap.isOpened()) {
            ...
            double frameRate = cap.get(Constants.CV_CAP_PROP_FPS);
            int frameWidth = (int)cap.get(Highgui.CV_CAP_PROP_FRAME_WIDTH);
            int frameHeight = (int)cap.get(Highgui.CV_CAP_PROP_FRAME_HEIGHT);
